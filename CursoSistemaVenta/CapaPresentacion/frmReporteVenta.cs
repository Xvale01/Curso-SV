    ...
    public partial class frmReporteVenta : Form
    {
        ...
        private void btnBuscarVentas_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                lista = new CN_Reporte().Venta(dtpFechaInicio.Value.ToString("dd/MM/yyyy"),
                    dtpFechaFin.Value.ToString("dd/MM/yyyy"), out mensaje);

                dgvdata.Rows.Clear();

                foreach (ReporteVenta entidad in lista)
                {
